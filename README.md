...
-   ✅ **CVE-2023-36464 fixed** - Migrated from `PyPDF2` to `pypdf` (>= 5.1.0) to prevent infinite loop vulnerability during PDF parsing.
-   📦 **Dependencies updated** - Optimized `requirements.txt` for better compatibility and security.
